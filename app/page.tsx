        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-between">
          <div className="w-full sm:mt-8 sm:w-5/6">
            ...
            <p className="my-4">
              ...
              building scalable microservices and infrastructure, with
              background interest in cloud technologies, system security, and
              web applications. I enjoy seeking out creative solutions to
              complex problems and building things that empower others to do the
              same.
            </p>
          ...
          <div>
            {Object.keys(TechStack).map((sectionName, idx) => (
              <TechLister
                ...
                sectionData={TechStack[sectionName as keyof typeof TechStack]}
                key={idx}
              />
            ))}
          </div>
